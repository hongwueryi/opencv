...
int main_face(int , char** )
{
    ...
    std::string cascadeFrontalfilename = "E:\\Dten\\other demo\\opencv\\opencv\\data\\lbpcascades\\lbpcascade_frontalface.xml"; //samples::findFile("data/lbpcascades/lbpcascade_frontalface.xml");
